function generatePassword() {
	...
	if (passwordLength >= 8 && passwordLength <= 128) {
		...
		window.alert(
			"The password length must be at least 8 characters long and no more than 128 characters long"
		);
		return password;
	}
}
// Fills an array with lowecase chars, uppercase chars, numbers and special chars
